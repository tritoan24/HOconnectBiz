...
class InputTextNumber extends StatefulWidget {
  final String? title;
  ...
  @override
  State<InputTextNumber> createState() => _InputTextNumberState();
}

class _InputTextNumberState extends State<InputTextNumber> {
  @override
    ...
    return Column(
      ...
      children: [
        ...
        FormBuilderTextField(
          ...
          keyboardType: TextInputType.number, // Changed to number keyboard
          inputFormatters: [
